...
export default function Home() {
    ...
    return (
        <div className="bg-linear-to-br from-yellow-500 via-green-400 to-blue-50 min-h-screen pt-28">
            <Navbar />
            <main className="grow w-full max-w-4xl mx-auto p-4 sm:p-8 my-5 sm:my-10 bg-white rounded-2xl shadow-2xl border border-gray-100 text-center text-gray-800">
